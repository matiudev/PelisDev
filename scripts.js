const peliculasTendencia = [
    ...
    },
    {
        ...
        imagen_horizontal: "peliculas/drama/mundos_paralelos/mundos-paralelos-horizontal.webp",
        genero: "Drama",
        descripcion:
    ...
    },
    {
        ...
        imagen_horizontal: "https://www.100hdwallpapers.com/wallpapers/1920x1080/titanic_movie-hd_wallpapers.jpg",
        genero: "Romance",
        descripcion:
    ...
    },
    {
        ...
        imagen_horizontal: "https://discordiamag.com/wp-content/uploads/2021/02/Portada-e1676814355157.jpg",
        genero: "Romance",
        descripcion:
...
const peliculasRecienEstrenadas = [
    {
        ...
        imagen_horizontal: "https://e.rpp-noticias.io/xlarge/2024/03/18/573157_1554528.webp",
        genero: "Ciencia ficción",
        descripcion: "Godzilla y Kong se enfrentan a una amenaza colosal escondida en lo profundo del planeta, desafiando su propia existencia y la supervivencia de la raza humana."
    },
    {
        titulo: "Abigail",
        año: 2024,
    ...
    },
    {
        ...
        año: 2024,
        imagen:"peliculas/infantil/garfield-fuera-de-casa/garfield-fuera-de-casa.webp",
        imagen_horizontal: "https://imagenes.heraldo.es/files/image_990_556/uploads/imagenes/2023/11/14/garfield-pelicula-2024-trailer-estreno.jpeg",
        genero: "Infantil",
        descripcion: "El mundialmente famoso Garfield, el gato casero que odia los lunes y que adora la lasaña, está a punto de vivir una aventura ¡en el salvaje mundo exterior! Tras una inesperada reunión con su largamente perdido padre."
    },
    {
        titulo: "Kung Fu Panda 4",
        año: 2024,
        imagen: "peliculas/infantil/kung-fu-panda-4/kung-fu-panda-4.jpg",
        imagen_horizontal: "https://rubik-audiovisual.com/wp-content/uploads/2024/03/kung-fu-panda-4-scaled.jpg",
        genero: "Infantil",
        descripcion: "Po está entrenando a un nuevo guerrero que ocupe su lugar para que él pueda convertirse en líder espiritual del Valle de la Paz. Sin embargo, la irrupción de una malvada hechicera que puede cambiar de apariencia trastoca sus planes."
    },
    {
        titulo: "Despicable Me 4",
        año: 2024,
        imagen: "peliculas/infantil/despicable-me-4/despicable-me-4.jpg",
        imagen_horizontal: "https://cooperativa.cl/noticias/site/artic/20240129/imag/foto_0000000220240129093758.jpg",
        genero: "Infantil",
        descripcion: "Despicable Me 4 es una próxima película de comedia animada estadounidense producida por Illumination y distribuida por Universal Pictures.",
    },
];
...
const seriesPopulares = [
    {
        ...
        genero: "Suspenso",
        descripcion: "Annalise Keating es una brillante y carismática profesora de derecho penal, que inesperadamente, tiene que aplicar todo el conocimiento práctico junto con sus estudiantes cuando se ven involucrados en un complot de asesinato en la universidad.",
    },
    {
        ...
        genero: "Drama Legal",
        descripcion: "El gran abogado corporativo de Manhattan, Harvey Specter y su equipo, se lanzan a un juego por obtener el poder cuando un nuevo socio se une a la empresa. Con sus dos mejores colegas fuera y Jessica de regreso en Chicago, Specter y el equipo intentan adaptarse a una nueva situación sin ellos.",
    },
    {
    ...
    },
    {
        titulo: "Cobra Kai",
        año: 2018,
        imagen: "series/drama/cobra-kai/MV5BYWU4ZmI0NTItZjcyNy00MzQ5LThiNDQtZDZkNjg1NWUwN2RhXkEyXkFqcGdeQXVyMTUzMTg2ODkz._V1_.jpg",
        imagen_horizontal: "series/drama/cobra-kai/16102988786234.webp",
        genero: "Drama",
        descripcion: "Treinta y cuatro años después de los eventos del torneo de karate All Valley de 1984, Johnny Lawrence busca la redención al abrir un dojo Cobra Kai, reavivando su rivalidad con un exitoso Daniel LaRusso.",
    },
]
...
function crearTarjetaPelicula(pelicula) {
    ...
    card.addEventListener("mouseover", () => {
        // Elimina cualquier temporizador pendiente
        clearTimeout(timeoutId);
    
        // Establece un nuevo temporizador de 1 segundo (1000 milisegundos)
      ...
      card.addEventListener("mouseout", () => {
        clearTimeout(timeoutId); // Elimina el temporizador
